...
def test_directories():
    ...
    for directory in ['code', 'lib', 'test']:
        yield n.assert_equal, os.path.isdir(directory)
        yield n.assert_equal, os.path.isfile(os.path.join(directory, '.gitignore'))

def test_readme():
    'A readme should be created with the appropriate sections.'
    init.readme()
    yield n.assert_equal, os.path.isfile('readme.md')
